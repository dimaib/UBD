...
Begin VB.Form Karta_t 
   ...
   Begin VB.Label Scroll_lb 
      ...
      Width           =   840
   End
   Begin MSForms.ComboBox List_God 
      Height          =   375
      Left            =   5400
      TabIndex        =   13
      Top             =   2520
   ...
   Begin MSForms.ComboBox List_n 
      ...
      FontPitchAndFamily=   2
   End
   Begin MSForms.ComboBox List_BCt 
      Height          =   375
      Left            =   5400
      TabIndex        =   0
      Top             =   1560
